...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a
                                        href="<?php echo site_url('mod_admin') ?>/ctl_admin/backend_main">Home</a></li>
                        ...
                        <section class="col-lg-12 connectedSortable">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"> <i class="fa fa-bars" aria-hidden="true"></i> Manage
                                        <?php echo $submenu; ?> </h3>
                                </div>
                                <div class="card-body">

                                    <div class="row"
                                        style="background-color: rgba(140, 175, 255, 0.15); padding: 20px; margin: 1px;border: 1px solid #87aaff; ">
                                        <div class="col-sm-12 text-right">
                                            <?php
                                            $pm_insertmain = chkPermissPage('product_insertmain');
                                            if ($pm_insertmain == 1) :
                                            ?>
                                            <a href=# class="btn_menumain btn btn-info btn-sm" data-type="main"
                                                data-toggle="modal" data-target=".modal-product">
                                                <li class="fa fa-plus-square-o "></li> ข้อมูลกลุ่ม
                                            </a>
                                            <a href=# class="btn_menumain btn btn-info btn-sm" data-type="submain"
                                                data-toggle="modal" data-target=".modal-product">
                                                <li class="fa fa-plus-square-o "></li> ข้อมูลหมวดหมู่
                                            </a>
                                            <a href=# class="btn_menumain btn btn-info btn-sm" data-type="type"
                                                data-toggle="modal" data-target=".modal-product">
                                                <li class="fa fa-plus-square-o "></li> ข้อมูลรูปแบบ
                                            </a>
                                            <a href=# class="btn_menumain btn btn-info btn-sm" data-type="category"
                                                data-toggle="modal" data-target=".modal-product">
                                            ...
                                            if ($pm_insertlist == 1) :
                                            ?>
                                            <a href="<?php echo site_url('mod_retailproduct') ?>/ctl_retailproduct/product_insertlist"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label class="small"> ตัวกรอง </label>
                                            <div class="d-flex">

                                                <div class="col ">
                                                    <select id="select-productmain" name="select-productmain"
                                                        class="form-control form-control-sm filter_menumain"
                                                        data-type="main">
                                                ...
                                                <div class="col">
                                                    <select id="select-productsubmain" name="select-productsubmain"
                                                        class="form-control form-control-sm filter_menumain"
                                                        data-type="submain">
                                                ...
                                                <div class="col">
                                                    <select id="select-producttype" name="select-producttype"
                                                        class="form-control form-control-sm filter_menumain"
                                                        data-type="type">
                                                ...
                                                <div class="col">
                                                    <select id="select-productcate" name="select-productcate"
                                                        class="form-control form-control-sm filter_menumain"
                                                        data-type="category">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label class="small"> เลือกการค้นหา (สถานะ) </label>
                                            <div class="input-group input-group-sm">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-default btn-sm"
                                                        id="bntvaldate"><i class="fas fa-search"></i> Search </button>
                                                    <button type="button" class="btn btn-default btn-sm"
                                                        id="refresh_page"><i class="fas fa-refresh"></i> Refresh
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="titel text-left col-md-12"> <i class="fa fa-file-text-o"
                                                        aria-hidden="true"></i> เนื้อหาเพิ่มเติม (Content)</div>
                                                <div id="resultcontent"
                                                    style="padding: 10px;border: 1px solid #7c7c7c; border-radius: 5px; ">
                                    ...
                                    <div class="modal fade md_proref bd-example-modal-lg" tabindex="-1" role="dialog"
                                        aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="titel text-left col-md-12"> <i class="fa fa-file-text-o"
                                                        aria-hidden="true"></i> โปรที่ผู้กับสินค้าชิ้นนี้</div>
            ...
            <!-- // ========== Modal ============ // -->
            <div class="modal fade modal-product bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name_th"
                                                            name="name_th" placeholder="Enter name">
                                                    </div>
                                                </div>

                                                <div class="card-footer text-right">
                                                    <button type="button" id="btn_modal_addproduct"
                                            ...
                                            <form id="frmmodal_edit" name="frmmodal_edit">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="edit_name_th"
                                                            name="edit_name_th" placeholder="Enter name">
                                                    </div>
                                                </div>

                                                <div class="card-footer text-right">
                                                    <button type="button" id="btn_modal_editproduct"
                                                        class="btn btn-primary mx-2 w-25">บันทึก</button>
                                                    <button type="button" id="btn_modal_delproduct"
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i
                                    class="fa fa-times-circle-o" aria-hidden="true"></i> ปิด</button>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        $(document).on('click', '#bntvaldate', function(event) {
            ...
            var selectproductsubmain = null;
            var selectproducttype = null;
            var selectproductcate = null;
            if ($('#select-productmain').val() != '') {
                selectproductmain = $('#select-productmain').val();
            }
            if ($('#select-productsubmain').val() != '') {
                selectproductsubmain = $('#select-productsubmain').val();
            }
            if ($('#select-producttype').val() != '') {
                selectproducttype = $('#select-producttype').val();
            }
            if ($('#select-productcate').val() != '') {
                selectproductcate = $('#select-productcate').val();
            }

            $('#ex1').DataTable().destroy();
            productlist(status, keyword, selectproductmain,selectproductsubmain,selectproducttype,selectproductcate);
        ...
        function productlist(status, keyword, selectproductmain,selectproductsubmain=null,selectproducttype=null,selectproductcate=null) {
            if (status == 0) {
                status = 'off';
            }
            var dataTable = $('#ex1').DataTable({
                ...
                "ajax": {
                    ...
                    data: {
                        ...
                        selectproductsubmain: selectproductsubmain,
                        selectproducttype: selectproducttype,
                        selectproductcate: selectproductcate
                    }
                },
                "columnDefs": [{
                        "targets": 0,
        ...
        //  filter
        /* $(".filter_menumain").on('select2:opening', function(event) {
            // $(this).select2('destroy');
            // $(this).trigger('click');
            let element = $(this);
            type = element.attr('data-type');
            async_getDataFilter(type);
        }) */
        $(document).on('click', ".filter_menumain", function() {
            let element = $(this);
            type = element.attr('data-type');
            async_getDataFilter(type);
        ...
        var paramFilter;
        async function async_getData(type, paramFilter = null) {
        ...
        function getData(type, paramFilter = null) {
            ...
            fetch(url + '?' + new URLSearchParams({
                ...
                .then(res => res.json())
                .then((resp) => {
                    return htmlSelectOption(resp, paramFilter);
                })
                .catch(function(error) {
                    alert(error);
                })
        ...
        //
        function htmlSelectOption(resp, paramFilter = null) {
            let option;
            if (paramFilter) {
                let txtname;
                switch (paramFilter) {
                ...
                option = '<option value="">--' + txtname + '--</option>';
            } else {
            ...
            $.each(resp, function(key, item) {
                ...
                option += '<option value="' + item.id + '" data-name="' + item.name + '" ' + (
                        htmlSelect == item.id ? 'selected' : '') + '>' + item.name + '(' + item.count +
                    ')</option>';
            })

            if (paramFilter) {
                $('.filter_menumain[data-type=' + paramFilter + ']').html(option).select2().blur();
                $('.filter_menumain[data-type=' + paramFilter + ']').select2('open');
            } else {
        ...
        //
        //  async for filter
        async function async_getDataFilter(type) {
            let result1 = await new Promise((resolve, reject) => {
                return resolve(
                    getData(type, type)
                )
